...
export namespace Prisma {
  ...
  */
  ...
  type GetFilmGroupByPayload<T extends FilmGroupByArgs> = PrismaPromise<
    Array<
  ...
  export type FilmGetPayload<
    S extends boolean | null | undefined | FilmArgs,
    U = keyof S
      > = S extends true
        ? Film
    : S extends undefined
    ? never
    : S extends FilmArgs | FilmFindManyArgs
    ?'include' extends U
    ? Film 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]:
    P extends keyof Film ? Film[P] : never
  } 
    : Film
  : Film


  type FilmCountArgs = Merge<
    Omit<FilmFindManyArgs, 'select' | 'include'> & {
      select?: FilmCountAggregateInputType | true
    }
  >

  export interface FilmDelegate<GlobalRejectSettings> {
    /**
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'Film'> extends True ? CheckSelect<T, Prisma__FilmClient<Film>, Prisma__FilmClient<FilmGetPayload<T>>> : CheckSelect<T, Prisma__FilmClient<Film | null >, Prisma__FilmClient<FilmGetPayload<T> | null >>
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'Film'> extends True ? CheckSelect<T, Prisma__FilmClient<Film>, Prisma__FilmClient<FilmGetPayload<T>>> : CheckSelect<T, Prisma__FilmClient<Film | null >, Prisma__FilmClient<FilmGetPayload<T> | null >>
    ...
    **/
    ...
    ): CheckSelect<T, PrismaPromise<Array<Film>>, PrismaPromise<Array<FilmGetPayload<T>>>>
    ...
    **/
    ...
    ): CheckSelect<T, Prisma__FilmClient<Film>, Prisma__FilmClient<FilmGetPayload<T>>>
    ...
    **/
     ...
     * })
    **/
    aggregate<T extends FilmAggregateArgs>(args: Subset<T, FilmAggregateArgs>): PrismaPromise<GetFilmAggregateType<T>>
    ...
    **/
    ...
    >(args: SubsetIntersection<T, FilmGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetFilmGroupByPayload<T> : PrismaPromise<InputErrors>
  }
   ...
   */
  export class Prisma__FilmClient<T> implements PrismaPromise<T> {
    [prisma]: true;
  ...
  export type FilmFindUniqueArgs = {
    ...
    **/
    ...
    /**
     * Throw an Error if a Film can't be found
     * 
    **/
  ...
  export type FilmScalarWhereWithAggregatesInput = {
    ...
    actors?: StringWithAggregatesFilter | string
