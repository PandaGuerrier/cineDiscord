            ...
            <div>
                ...
                <div className={style.center_div_film_creator}>
                    <div className={style.width_input}>
                        ...
                        <form action="/api/film/modify" method="post" className={style.form}>
                            <div>
                            ...
                            <div>
                                ...
                                <input type="text" className={style.input_search_film} name="title" placeholder="Titre du film (ex: Harry Potter 1)"/>
                            </div>
                            <div>
                                <label className={style.label_user} htmlFor="description">Description: </label> <br/>
                                <textarea type="text" className={style.input_search_film} id={style.textarea} name="description" placeholder="Descritpion du film"/>
                            </div>
                            <div>
                                <label className={style.label_user} htmlFor="releaseDate">Date de sortie: </label> <br/>
                                <input type="date" className={style.input_search_film} name="releaseDate" />
                            </div>
                            <div>
                                <label className={style.label_user} htmlFor="image">Image :</label> <br/>
                                <input type="text" className={style.input_search_film} name="image" placeholder="https://lien_de_l'image.com"/>
                            </div>
                            <div>
                                <label className={style.label_user} htmlFor="actors">Acteurs : </label> <br/>
                                <input type="text" className={style.input_search_film} name="actors" placeholder="Tom holland, Mapoto40, Panda_Guerrier, ..."/>
                            </div>
                            <div>
